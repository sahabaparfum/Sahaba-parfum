...
const Femme = () => {
  ...
  if (loading) return <div className="flex justify-center items-center h-screen bg-[#050505] text-[#D4AF37] uppercase font-black tracking-widest text-xs">Chargement...</div>;
  ...
  return (
    <div className="bg-[#050505] text-white max-w-7xl mx-auto px-4 py-12 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6 border-b border-[#D4AF37]/20 pb-8">
        <div>
          <h1 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter bg-gradient-to-r from-white to-[#D4AF37] bg-clip-text text-transparent">Collection Femme</h1>
          <p className="text-[10px] text-zinc-500 uppercase tracking-widest mt-1">L'élégance au féminin</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
        {currentProducts.length > 0 ? (
          ...
          <p className="col-span-full text-center py-20 text-zinc-500 italic text-sm font-bold uppercase tracking-widest">
